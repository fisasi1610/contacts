...
EOD;
  ...
  public function prepare() {
    ...
    $modulePath   = str_replace([
        ...
        DIRECTORY_SEPARATOR . 'protected' . DIRECTORY_SEPARATOR,
    ...
    $this->files[] = new CCodeFile(
      $modulePath . '/' . $this->moduleClass . '.php', $this->render($moduleTemplateFile)
    );
    ...
    foreach ($files as $file) {
      if ($file !== $moduleTemplateFile) {
        ...
        $this->files[] = new CCodeFile(
          $modulePath . substr($file, strlen($templatePath)), $content
        );
      }
    }
  }
