 ...
 */
class UsuarioModel extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('ultimo_acceso', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, persona_id, estado, usuario, clave, ultimo_acceso', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return UsuarioModel the static model class
	 */
